		...
		*/
		...
		pagination: function(target, table, pagiclasses, pagiitemclasses, pagilinksclasses, paginextclasses, paginextlinkclasses, paginextlinkmarkup, pagiprevclasses, pagiprevlinkclasses, pagiprevlinkmarkup, pages) {
			...
			for (var i = 0; i < info.recordsTotal; i++) {
				if (i % info.length == 0) {
					paginationMarkup += i / info.length == 0 ? '<li class="' + pagiitemclasses + '"><a id="datatablePaginationPage' + (i / info.length) + '" class="' + pagilinksclasses + ' active" href="hs.datatables.js#!" data-dt-page-to="' + (i / info.length) + '">' + ((i / info.length) + 1) + '</a></li>' : '<li class="' + pagiitemclasses + '"><a id="' + target + (i / info.length) + '" class="' + pagilinksclasses + '" href="hs.datatables.js#!" data-dt-page-to="' + (i / info.length) + '">' + ((i / info.length) + 1) + '</a></li>';
				}
			}
			...
			$('#' + target).html(
				...
				<a id="' + target + 'Prev" class="' + pagiprevlinkclasses + '" href="hs.datatables.js#!" aria-label="Previous">' + pagiprevlinkmarkup + '</a>\
				</li>' +
				paginationMarkup +
				'<li class="' + paginextclasses + '">\
				<a id="' + target + 'Next" class="' + paginextlinkclasses + '" href="hs.datatables.js#!" aria-label="Next">' + paginextlinkmarkup + '</a>\
				</li>\
				</ul>'
			);
